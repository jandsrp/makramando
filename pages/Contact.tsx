      ...
      <div className="flex flex-col gap-12">
        <section className="flex flex-col md:flex-row gap-8 items-start justify-between">
          ...
          <div className="hidden lg:block w-32 h-32 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl rotate-3">
            <img src="https://picsum.photos/400/400?random=macrame" alt="Textura" className="w-full h-full object-cover" />
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="relative rounded-3xl overflow-hidden mt-6 aspect-video">
               <img src="https://picsum.photos/800/600?random=workshop" className="w-full h-full object-cover" />
                ...
                <form className="flex flex-col gap-6" onSubmit={e => e.preventDefault()}>
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <label className="flex flex-col gap-2">
                        ...
                        <input className="form-input rounded-xl border-gray-100 dark:border-gray-800 dark:bg-gray-800 dark:text-white h-14" placeholder="Maria Silva" />
                      </label>
                      <label className="flex flex-col gap-2">
                        <span className="text-sm font-bold dark:text-white">Seu E-mail</span>
                        <input className="form-input rounded-xl border-gray-100 dark:border-gray-800 dark:bg-gray-800 dark:text-white h-14" placeholder="maria@email.com" />
                      </label>
                   </div>
                   <label className="flex flex-col gap-2">
